...
public class TodaySpendingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_today_spending, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        totalAmountSpendOn = view.findViewById(R.id.totalAmountSpendOn);
...
//        databaseReference = firebaseDatabase.getReference();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), DailyAnalyticActivity.class));
            }
        });

        myDatalist = new ArrayList<>();
        todayItemsAdapter = new TodayItemsAdapter(getActivity(), myDatalist);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        switch (Item) {
                            case "Transport":
                                ...
                                if (itemPercent >=80) {
                                    Toast.makeText(getActivity(), "You have used up " + itemPercent + " of your daily budget!", Toast.LENGTH_SHORT).show();
                                }
                                break;
                    ...
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(getActivity(), "Expense item added successfully", Toast.LENGTH_SHORT).show();
                                loader.dismiss();
                                getActivity().finish();
                            }
                        }
